...
def separador_codigo(precos, tamanhos, fator=0.1):
    if len(precos) == len(tamanhos):
        ...
        return preco_teste, preco_treino, tamanho_teste, tamanho_treino
    else:
        print('São de tamanhos diferentes.')
        return
preco_teste, preco_treino, tamanho_teste, tamanho_treino= separador_codigo(precos_imoveis, tamanho_imoveis)
print(preco_treino)
