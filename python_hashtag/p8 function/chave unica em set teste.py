...
Isso significa que na prática, caímos em muitos casos de ter uma lista de produtos, mas quando olhamos por exemplo uma base com a posição em
estoque de cada produto, surge nessa “base” produtos que não existiam na nossa lista inicial.
...
Vamos criar uma function que pega todas essas listas e cria, a partir dela, uma lista de produtos. Com o objetivo de saber todos os
produtos que temos na empresa. Repare que a function pode receber 1, 2, 3 ou quantas listas de estoque forem necessárias.
...
def listar_produtos(*listas):
    lista_produtos = []
    for lista in listas:
        for produto, qtde_estoque in lista:
...
print(listar_produtos(estoque_fim_jan))
