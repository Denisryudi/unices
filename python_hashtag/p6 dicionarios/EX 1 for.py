...
for estado in niveis_co2:
    tamanho = len(niveis_co2[estado])
    media = sum(niveis_co2[estado])/tamanho
    if media >= 450:
        print('Os estados que estão em perigo são: {}, com niveis de co2 de {}, acima do permitido de 450.'.format(estado, media))
